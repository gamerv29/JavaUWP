...
Controller diagnostics for both Fabric and Forge controller mods are written to `xbox_compat.log` in the active profile game folder and are included in crash report uploads.
